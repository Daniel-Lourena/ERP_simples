...
namespace ModuloCadastro.Migrations
{
    ...
    [Migration("20260408003821_db_07_04_2026")]
    partial class db_07_04_2026
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModuloCadastro.Entity.Cadastro.Usuario.UsuarioPermissaoEntity", b =>
                {
            ...
            modelBuilder.Entity("ModuloCadastro.Entity.Financeiro.AdquirenteBandeira", b =>
                {
                    ...
                    b.HasKey("ConfigAdquirenteId", "BandeiraId");

                    b.ToTable("tb_adquirente_bandeira");
                });
            ...
            modelBuilder.Entity("ModuloCadastro.Entity.Financeiro.ConfigAdquirenteEntity", b =>
                {
                    ...
                    b.Property<int>("NroPacelas")
                        .HasColumnType("int");

                    b.Property<decimal>("TaxaAntecipacao")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("TaxaCreditoAVista")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("ModuloCadastro.Entity.Cadastro.Usuario.UsuarioPermissaoEntity", b =>
                {
                    b.HasOne("ModuloCadastro.Entity.Cadastro.Usuario.UsuarioEntity", "Usuario")
                        .WithMany("ListaPermissoes")
